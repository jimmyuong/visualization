<template>
  ...
  <Box positionValue="400,1180" title="繁體是這樣的" type="type1" ></Box>
  <Pie positionValue="400,1770" title="日本語ってこんな感じ"></Pie>
  <Box positionValue="800,000" title="한국어는 이렇다" type="type1" ></Box>
  <Box positionValue="800,590" title="ENGLISH LIKE" type="type2" ></Box>
  <Box positionValue="800,1180" title="ENGLISH LIKE" type="type2" ></Box>
  <Pie positionValue="800,1770" title="日本語ってこんな感じ"></Pie> -->
</template>

<script>
import BoxBlue from '@/components/BoxBlue.vue'
...
return {
  ...
  boxparameter4:{
    ...
    visualstyle:"bar", 
    datas:this.dataArray,
    //chartstyle:"Stackedlinechart"
    chartstyle:"Stackedlinechart"
  },
  boxparameter5:{
    positionValue:"400,590",
    width:"100%",
    height:'340px',
    title:"中文是这样的", 
    type:"type1", 
    visualstyle:"bar", 
    datas:this.dataArray,
    chartstyle:"DatasetinObjectArray"
  },
  boxparameter6:{
    positionValue:"400,1180",
    width:"100%",
    height:'340px',
    title:"日本語ってこんな感じ", 
    type:"type1", 
  ...
  boxparameter7:{
    ...
    visualstyle:"bar", 
    datas:this.dataArray,
    chartstyle:"Basicradarchart"
  },
  boxparameter8:{
    positionValue:"800,590",
    width:"100%",
    height:'280px',
    title:"日本語ってこんな感じ", 
    type:"type3", 
  ...
  boxparameter12:{
    ...
    width:"100%",
    height:'340px',
    title:"RefererofaWebsite", 
    type:"type1", 
    visualstyle:"bar", 
    datas:this.dataArray,
    chartstyle:"RefererofaWebsite"
  },
  boxparameter13:{
    positionValue:"800,1770",
    width:"100%",
    height:'340px',
    title:"中文是这样的", 
    type:"type3", 
